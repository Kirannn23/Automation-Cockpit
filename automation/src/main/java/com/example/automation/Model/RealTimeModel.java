...
@NamedStoredProcedureQuery(
	    ...
	    parameters = {
	        ...
	        @StoredProcedureParameter(mode = ParameterMode.IN, name = "p_BotId1", type = Integer.class),
	        @StoredProcedureParameter(mode = ParameterMode.IN, name = "p_DepartmentId1", type = Integer.class),
	        @StoredProcedureParameter(mode = ParameterMode.IN, name = "p_LocationId1", type = Integer.class),
